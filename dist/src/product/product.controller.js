...
let ProductController = class ProductController {
    ...
    getProducts(category, features, page, size) {
        return __awaiter(this, void 0, void 0, function* () {
            const params = {
                category,
                features,
            ...
            return yield this.productService.getAll(params);
        });
    }
    ...
    updateProduct(productId, data) {
        return __awaiter(this, void 0, void 0, function* () {
            return this.productService.update(Object.assign({ id: productId }, data));
        });
    }
...
__decorate([
    ...
    __param(1, common_1.Query('features')),
    __param(2, common_1.Query('page')),
    __param(3, common_1.Query('size')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Number, Array, Number, Number]),
    __metadata("design:returntype", Promise)
